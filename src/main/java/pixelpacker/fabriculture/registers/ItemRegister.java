...
public class ItemRegister {
    ...
    public static final Item IRON_SEED = new AliasedBlockItem(BlockRegister.IRON_CROP, new Item.Settings().group(ItemGroupRegister.FABRICULTURE_GROUP));
    public static final Item IRON_ESSENCE = new Item(new FabricItemSettings().group(ItemGroupRegister.FABRICULTURE_GROUP));
